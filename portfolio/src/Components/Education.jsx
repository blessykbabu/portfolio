...
export default function Education(){
 return(
   ...
   <h4 className="mb-4" style={{textAlign:"center",color:"white"}}>Learning Journey</h4>
   <div className="container">
    ...
    <h4 className="mb-4" style={{color:"white"}}>BACHELOR OF COMPUTER APPLICATION</h4>
    ...
    <h4 className="mb-4" style={{color:"white"}}> HIGHER SECONDARY EDUCATION</h4>
    ...
    <h4 className="mb-4" style={{color:"white"}}>SECONDARY SCHOOL EDUCATION </h4>
